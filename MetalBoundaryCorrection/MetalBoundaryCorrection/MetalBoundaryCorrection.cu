...
{
	//ImageIO m_io;
	//m_io.FreeImg(m_labels);
	//m_io.FreeImg(m_newLabels);
	//m_io.FreeImg(m_strength);
	//m_io.FreeImg(m_newStrength);
...
void MetalBoundaryCorrection::initializeCPU()
{
	...
	//ImageIO m_io;
	//m_labels = m_io.AllocateImg<int>(cols, rows);
	//m_newLabels = m_io.AllocateImg<int>(cols, rows);
	//m_strength = m_io.AllocateImg<float>(cols, rows);
	//m_newStrength = m_io.AllocateImg<float>(cols, rows);
...
//
////////////////////////////////////////////////////////////////////////
void MetalBoundaryCorrection::test()
{
	int i, j;
	float sum = 0;
	float sum2 = 0.0f;
...
//
////////////////////////////////////////////////////////////////////////
void MetalBoundaryCorrection::refineBoundary(float **image, float **mask)
{
